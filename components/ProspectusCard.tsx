...
export default function ProspectusCard() {
  return (
    <div className="bg-ink text-white rounded-card p-8 flex flex-col justify-between">
      <div>
        <h4 className="font-display text-white text-xl mb-1.5">Get the full prospectus</h4>
        <p className="text-[#B9C2D6] text-sm mb-0">
      ...
      <a
        ...
        className="btn btn-ghost btn-sm mt-2.5 justify-center border-white text-white"
      >
